...
export default function AdminLayout({
  ...
  const navigationItems = [
    ...
    {href:"/dashboard/perfis", label:"Perfis"},
    ...
    {href:"/dashboard/solicitacoes-ferias", label:"Solicitações de Férias"},
    {href:"/dashboard/saldo-ferias", label:"Saldo de Férias"},
    {href:"/dashboard/relatorio-horas", label:"Relatório de Horas"},
